...
export class TransferablePolylineGeometry {
  free(): void;
  constructor(position: TransferableFloatAttribute, position_high: TransferableFloatAttribute | null | undefined, position_low: TransferableFloatAttribute | null | undefined, start: TransferableFloatAttribute, start_high: TransferableFloatAttribute | null | undefined, start_low: TransferableFloatAttribute | null | undefined, forward_offset: TransferableFloatAttribute, end_high: TransferableFloatAttribute | null | undefined, end_low: TransferableFloatAttribute | null | undefined, start_normals: TransferableFloatAttribute, end_normal_and_texture_coordinate_normalization_x: TransferableFloatAttribute, right_normal_and_texture_coordinate_normalization_y: TransferableFloatAttribute, batch_ids: TransferableFloatAttribute | null | undefined, batch_index: TransferableUintAttribute | null | undefined, indices: number);
...
export interface InitOutput {
  ...
  readonly core_readPropertiesFromFeature: (a: number, b: bigint, c: any) => [number, number];
