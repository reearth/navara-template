...
export function constructPolygonBatchedFeature(features: TransferablePolygonBatchedFeature, material: PolygonMaterial, flat: boolean): ConstructedPolygonGeometry | undefined;
...
export interface InitOutput {
  ...
  readonly start: () => void;
  readonly constructPolygonBatchedFeature: (a: number, b: number, c: number) => number;
