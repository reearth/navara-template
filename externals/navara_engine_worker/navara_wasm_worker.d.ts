/* tslint:disable */
/* eslint-disable */
export function constructPolylineBatchedFeature(features: TransferablePolylineBatchedFeature, material: PolylineMaterial, flat: boolean): ConstructedPolylineGeometry | undefined;
export function constructTerrainMesh(bytes: Uint8Array, tile: TransferableTile, raster_dem_data: TransferableRasterDEMData, martini: TransferableMartini, skirt: boolean, skirt_exaggeration: number): ReturnedConstructedTerrainMesh;
export function upsampleTerrainMesh(tile: TransferableTile, parent_tile: TransferableTile, raster_dem_data: TransferableRasterDEMData, upsamplable_geometry: UpsamplableTerrainGeometry, skirt: boolean, skirt_exaggeration: number): ReturnedConstructedTerrainMesh;
export function start(): void;
export function constructPolygonBatchedFeature(features: TransferablePolygonBatchedFeature, material: PolygonMaterial, flat: boolean, tile_extent?: ExtentRadianF32 | null): ConstructedPolygonGeometry | undefined;
/**
...
export class BillboardMaterial {
   ...
   */
  get selectiveEffectOcclusion(): string | undefined;
  /**
   * Depth behavior for selective effect mask passes: "normal" or "silhouette"
   */
  set selectiveEffectOcclusion(value: string | null | undefined);
  /**
...
export interface InitOutput {
  ...
  readonly constructPolylineBatchedFeature: (a: number, b: number, c: number) => number;
  readonly constructTerrainMesh: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
  readonly upsampleTerrainMesh: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly start: () => void;
  readonly constructPolygonBatchedFeature: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly __wbg_get_pointmaterial_selectiveEffectOcclusion: (a: number) => [number, number];
  readonly __wbg_set_pointmaterial_selectiveEffectOcclusion: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_get_billboardmaterial_selectiveEffectOcclusion: (a: number) => [number, number];
  readonly __wbg_set_billboardmaterial_selectiveEffectOcclusion: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_get_polylinematerial_selectiveEffectOcclusion: (a: number) => [number, number];
  readonly __wbg_set_polylinematerial_selectiveEffectOcclusion: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_get_polygonmaterial_selectiveEffectOcclusion: (a: number) => [number, number];
  readonly __wbg_set_polygonmaterial_selectiveEffectOcclusion: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_get_modelmaterial_selectiveEffectOcclusion: (a: number) => [number, number];
  readonly __wbg_set_modelmaterial_selectiveEffectOcclusion: (a: number, b: number, c: number) => void;
