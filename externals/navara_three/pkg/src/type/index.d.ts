...
import { AerialPerspectiveConfig, CloudsConfig, FinalCopyPassConfig, FogLightConfig, FXAAConfig, LensFlareConfig, MRTPassConfig, SMAAConfig, SSAOConfig, SSRConfig, ToneMappingConfig, TransparentPassConfig } from '../layers/effect';
...
export type EffectLayerDeclarationDescription = AerialPerspectiveConfig | CloudsConfig | FinalCopyPassConfig | FogLightConfig | FXAAConfig | LensFlareConfig | MRTPassConfig | SMAAConfig | SSAOConfig | SSRConfig | ToneMappingConfig | TransparentPassConfig;
